...
* ЛР#2: 21 октября (отлично), 28 октября (хорошо)
* ЛР#3
...
[2] Если вы поклонник ОС отличной от Linux вы можете написать мне письмо и мы подберем вам подходящий инструмент.
